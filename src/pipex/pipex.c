...
// /*   Updated: 2023/09/11 20:15:31 by mehdimirzai      ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// 	close(pipes[0][1]);
// 	if (args.temp_file_created == true)
// 		file = open(args.av[*(args.ac) - 1], O_WRONLY | O_CREAT | O_APPEND, 0644);
// 	else
// 		file = open(args.av[*(args.ac) - 1], O_WRONLY | O_CREAT | O_TRUNC, 0644);
// 	if (file == -1)
// 		exit(127);
