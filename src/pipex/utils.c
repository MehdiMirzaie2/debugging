...
// /*   Updated: 2023/09/11 20:17:11 by mehdimirzai      ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */

// #include "pipex.h"

// char	**custom_split(char *cmd)
// {
// 	int	i;
// 	int	j;
// 	char	*temp;
...
// 	cmds_splitted = malloc(sizeof(char *) * 3);
// 	if (cmds_splitted == NULL)
// 		return (NULL);
// 	i = 0;
// 	temp = cmd;
// 	while (temp[i] != ' ')
// 		i++;
// 	cmds_splitted[0] = ft_substr(temp, 0, i);
// 	// free(temp);
// 	// i = 0;
// 	// temp = cmd_splitted[1];
...
// 		j--;
// 	// while (temp[j] && temp[j] != '\'' && temp[j] != '\"' && (temp[j - 1] == '}' || temp[j - 1] == '/'))
// 	// 	j++;
// 	if (temp[j + 1] != '\'' || temp[j + 1] != '\"')
// 		cmds_splitted[1] = ft_substr(temp, i, j);
// 	// else
// 	cmds_splitted[1] = ft_substr(temp, i, j + 1 - i);
// 	cmds_splitted[2] = NULL;
// 	return (cmds_splitted);
// 	// free(temp);
// }
